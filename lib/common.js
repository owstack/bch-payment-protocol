...
var varintBufNum = bchLib.encoding.BufferWriter.varintBufNum;
...
PaymentProtocol.PAYMENT_REQUEST_CONTENT_TYPE = 'application/bitcoincash-paymentrequest';
PaymentProtocol.PAYMENT_CONTENT_TYPE = 'application/bitcoincash-payment';
PaymentProtocol.PAYMENT_ACK_CONTENT_TYPE = 'application/bitcoincash-paymentack';
...
function magicHash(str) {
  var magicBytes = new Buffer('Bitcoin Cash Signed Message:\n');
